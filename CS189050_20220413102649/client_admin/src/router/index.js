...
const routes = [
	...
	// 图书商城路由
	{
		path: '/book_mall/table',
		name: 'book_mall_table',
		component: () => import('../views/book_mall/table.vue')
	},
	{
		path: '/book_mall/view',
		name: 'book_mall_view',
		component: () => import('../views/book_mall/view.vue')
	},
	// 销售榜单路由
	{
		path: '/sales_list/table',
		name: 'sales_list_table',
		component: () => import('../views/sales_list/table.vue')
	},
	{
		path: '/sales_list/view',
		name: 'sales_list_view',
		component: () => import('../views/sales_list/view.vue')
	},
	// 留言箱路由
	{
