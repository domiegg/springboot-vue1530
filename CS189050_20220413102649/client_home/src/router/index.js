...
const routes = [
	...
	//图书商城列表路由
	{
		path: '/book_mall/list',
		name: '/book_mall_list',
		component: () => import('../views/book_mall/list.vue')
	},
	//图书商城详情路由
	{
		path: '/book_mall/details',
		name: '/book_mall_details',
		component: () => import('../views/book_mall/details.vue')
	},
	//留言箱添加路由
	{
...
router.afterEach((to, from, next) => {
	let title = "三味书屋网络书店销售管理-home";
	document.title = title;
	document.logo = "三味书屋网络书店销售管理"
})
